...
int main(void){
  ...
  struct person new_person;
    ...
    FILE *phonedir = fopen("/workspaces/C-2024-DevContainerLinux/Exercices/exercises/exercise_11_3/phonedir.txt","w");
...
for(int i = 0 ;i < 50 ;i++){
        ...
        FILE *phonedir_append = fopen("/workspaces/C-2024-DevContainerLinux/Exercices/exercises/exercise_11_3/phonedir.txt","a");
